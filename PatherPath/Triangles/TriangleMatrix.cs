...
namespace WowTriangles
{
    ...
    public class TriangleMatrix
    {
        ...
        public List<int> GetAllCloseTo(float x, float y, float distance)
        {
            var close = matrix.GetAllInSquare(x - distance, y - distance, x + distance, y + distance);
        ...
        public List<int> GetAllInSquare(float x0, float y0, float x1, float y1)
        {
            var all = new List<int>();
            var close = matrix.GetAllInSquare(x0, y0, x1, y1);
